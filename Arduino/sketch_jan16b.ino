...
void loop() {
 ...
 if (preheatSec > 0) {
     ...
     String sen="";
     sen=sen+"target=devices01&devicesid=01&status=runing&time=null&obj=[";
     sen=sen+"{\"id\": \"sensor01\", \"type\": \"CO2\", \"value\":" + ppm +", \"status\": \"test\"}";
    sen=sen+", ";
 
  if (! isnan(t))
  {
    sen=sen+"{\"id\": \"sensor02\", \"type\": \"tm\", \"value\":" + t +", \"status\": \"test\"}";
  } 
  else{
    t=-1;
    sen=sen+"{\"id\": \"sensor02\", \"type\": \"tm\", \"value\":" + t +", \"status\": \"test\"}";
  ...
  if (! isnan(h)) 
  {
   sen=sen+"{\"id\": \"sensor03\", \"type\": \"humid\", \"value\":" + h +", \"status\": \"test\"}";
  } 
  else{
    h=-1;
    sen=sen+"{\"id\": \"sensor03\", \"type\": \"humid\", \"value\":" + h +", \"status\": \"test\"}";
