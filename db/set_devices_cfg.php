...
if (mysqli_num_rows($r)==1) {
    ...
    //echo "not exist";
    $s="CREATE TABLE ".$target." ( id VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , status VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , year VARCHAR(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, month VARCHAR(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , day VARCHAR(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , time VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL , value JSON NOT NULL ) ENGINE = InnoDB";
    $link->query($s);
    $s="INSERT INTO "."$table"."(target,id,value) VALUES('"."$target"."','"."$devicesid"."','"."$obj"."')";
    $link->query($s);
}
