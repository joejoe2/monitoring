...
public class SimulateGateways {
    ...
    static String server = "192.168.1.2";
    ...
    public static void main(String[] args) {
        ...
        Timer timer1 = new Timer(5000, (e) -> {
            ...
            try {
                ...
                Socket socket = (SSLSocket) socketFactory.createSocket(server, entry);
                
                OutputStream outputStream = socket.getOutputStream();
                PrintWriter printWriter = new PrintWriter(outputStream, true);
                String json = "[{\"id\": \"sensor01\", \"type\": \"tm\", \"value\": " + (random.nextFloat() * 100) + ", \"status\": \"test\"}, {\"id\": \"sensor02\", \"type\": \"tm\", \"value\":" + (random.nextFloat() * 100) + ", \"status\": \"test\"}, {\"id\": \"sensor03\", \"type\": \"tm\", \"value\":" + (random.nextFloat() * 100) + ", \"status\": \"test\"}]";
        ...
        Timer timer2 = new Timer(5000, (e) -> {
            ...
            try {
                ...
                PrintWriter printWriter = new PrintWriter(outputStream, true);
                String json = "[{\"id\": \"sensor01\", \"type\": \"tm\", \"value\": " + (random.nextFloat() * 100) + ", \"status\": \"test\"}, {\"id\": \"sensor02\", \"type\": \"tm\", \"value\":" + (random.nextFloat() * 100) + ", \"status\": \"test\"}, {\"id\": \"sensor03\", \"type\": \"tm\", \"value\":" + (random.nextFloat() * 100) + ", \"status\": \"test\"}]";
                String urlParameters = "target=devices02&devicesid=02&status=normal&time=" + LocalDateTime.now().toString() + "&obj=" + json;
                printWriter.println(urlParameters);
                printWriter.flush();
                printWriter.close();
                outputStream.close();
